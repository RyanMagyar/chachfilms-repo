...
class Movie extends React.Component {
    constructor(props) {
        ...
        this.state = {
            currentState: movieState, showWatched: false, fade: false,
            showDeleted: false, isLoggedIn: userToken, showInRotation: false,
            showOnDeck: false, showWarning: false, ratings: this.props.ratings,
    ...
    render() {
        ...
        return (
            <div className="movieDiv">
                ...
                <Modal centered contentClassName='deletedModal' backdrop={backdrop} show={showDeleted} animation={false} onHide={() => this.setState({ showDeleted: false })}>
                    {filmLoading ?
