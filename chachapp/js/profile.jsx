...
class Profile extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            message: '', isLoggedIn: userToken, oldPassword: '',
            ...
            bioErrorMessage: '', bioSuccessMessage: '', bioCharsLeft: 256, bioChanged: false,
        };
        ...
        return (
            <div className="login-wrapper">
                ...
                <div className="pic-wrapper">
                    <input type="file" className="fileInput" name="profilePicBtn" accept="image/png, image/jpeg, image/jpg, image/gif" onChange={this.profilePicChange} />
                    <ImageCropper
                ...
                <div className="editBioWrapper">
                    ...
                    <Button onClick={this.handleBioSubmit} disabled={!this.state.bioChanged} className="bioBtn">Save Bio</Button>
